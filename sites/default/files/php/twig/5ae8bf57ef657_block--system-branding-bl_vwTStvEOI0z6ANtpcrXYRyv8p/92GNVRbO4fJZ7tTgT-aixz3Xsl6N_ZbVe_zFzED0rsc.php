...
{% block content %}
  {% if site_logo %}
    <a class=\"logo navbar-btn pull-left\" href=\"{{ path('<front>') }}\" title=\"{{ 'Home'|t }}\" rel=\"home\">
      <img src=\"{{ site_logo }}\" alt=\"{{ 'Home'|t }}\" class=\"bootstrap_logo\" />
    </a>
  {% endif %}
  {% if site_name %}
  ...
  {% endif %}
{% endblock %}
", "themes/bootstrap/templates/block/block--system-branding-block.html.twig", "C:\\xampp\\htdocs\\fluffymonsters\\themes\\bootstrap\\templates\\block\\block--system-branding-block.html.twig");
    }
}
